 ...
 */
public class Mail {
    // The mailbox and password of sender
    private static String myEmailAccount = "staryBlog@163.com";
    private static String myEmailPassword = "yanzexin9610";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般格式为: smtp.xxx.com
    private static String myEmailSMTPHost = "smtp.163.com";

    public static MimeMessage createMimeMessage(Session session, String receiveMail, String messages) throws Exception {
        // 1. 创建一封邮件
    ...
    public static void send(String receiver, String messages) throws Exception {
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, receiver, messages);
